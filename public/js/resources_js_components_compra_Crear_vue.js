                        ...
                        _c(
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.compra.proveedor_id,
                                expression: "compra.proveedor_id",
                              },
                            ],
                            staticClass: "form-control",
                            attrs: { id: "proveedor" },
                          ...
                          _vm._l(_vm.proveedores, function (proveedor) {
                            return _c(
                              ...
                              [_vm._v(_vm._s(proveedor.pvd_nombre))]
                            )
                          }),
                          0
                        ),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.compra.com_direccion,
                              expression: "compra.com_direccion",
                            },
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.compra.com_direccion },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
