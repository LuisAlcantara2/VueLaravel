...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get('/api/getVentas', {
                  params: {
                    mes: _this.mes,
                    año: _this.año
                  }
                }).then(function (response) {
                  _this.ventas = response.data.venta;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.axios.get('/api/getCompras', {
                  params: {
                    mes: _this2.mes,
                    año: _this2.año
                  }
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this3.axios.get('/api/getSaldo', {
                  params: {
                    mes: _this3.mes,
                    año: _this3.año
                  }
                }).then(function (response) {
                  _this3.saldo = response.data.saldo;
                })["catch"](function (error) {
                  _this3.saldo = 0.00;
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _this4.axios.get('/api/getAños').then(function (response) {
                  _this4.años = response.data.anios;
                })["catch"](function (error) {
                  _this4.años = [];
                });
    ...
    getReporte1: function getReporte1() {
      var _this5 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this5.series[0].data = [];
                _this5.chartOptions.xaxis.categories = [];
                cat = [];
                _context5.next = 5;
                return _this5.axios.get('/api/reporteVenta').then(function (response) {
                  _this5.reporte = response.data.venta;

                  _this5.reporte.forEach(function (element) {
                    cat.push(element.name);

                    _this5.series[0].data.push(element.data);
                  });

                  _this5.$refs.realtimeChart.updateSeries([{
                    data: _this5.series[0].data
                  }], false, true);

                  _this5.chartOptions = _objectSpread(_objectSpread({}, _this5.chartOptions), {
                    xaxis: {
                      categories: cat
                    }
                  });
    ...
    getReporte2: function getReporte2() {
      var _this6 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _this6.series2 = [];
                _this6.chartOptions2.labels = [];
                cat = [];
                _context6.next = 5;
                return _this6.axios.get('/api/reporteVenta2', {
                  params: {
                    mes: _this6.mes,
                    año: _this6.año
                  }
                }).then(function (response) {
                  _this6.reporte = response.data.productos;

                  _this6.reporte.forEach(function (element) {
                    cat.push(element.nombre);

                    _this6.series2.push(Number(element.cantidad));
                  });

                  _this6.chartOptions2 = _objectSpread(_objectSpread({}, _this6.chartOptions), {
                    labels: cat
                  });
                })["catch"](function (error) {});
          ...
          "select",
          {
            ...
            on: {
              change: function ($event) {
                ...
                _vm.año = $event.target.multiple
                  ? $$selectedVal
                  : $$selectedVal[0]
              },
            },
          },
          _vm._l(_vm.años, function (anio) {
            return _c(
              "option",
              { key: anio.year, domProps: { value: anio.year } },
              [_vm._v(_vm._s(anio.year))]
            )
          }),
          0
        ),
      ...
      _c("div", { staticClass: "col-3 mb-2" }, [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("option", { attrs: { value: "9" } }, [_vm._v("Setiembre")]),
            _vm._v(" "),
    ...
    _c("div", { staticClass: "row justify-content-between" }, [
      _c("div", { staticClass: "col-4" }, [
        _c("div", { staticClass: "alert alert-dark" }, [
          _c("h5", { staticClass: "card-title" }, [_vm._v("Ventas del mes")]),
          _vm._v(" "),
          _c("strong", [
            _c(
              "p",
              {
                staticClass: "card-text text-end",
                staticStyle: { "font-size": "xxx-large" },
              },
              [_vm._v(_vm._s(this.ventas))]
            ),
          ]),
        ]),
      ]),
